...
function App() {
  useEffect(() => {
    // Se eu estiver no ambiente de desenvolvimento, não disparo pixels à toa
    // Para fazer testes no pixel, uso o ambiente de produção (hosting) ou comento a linha
    ...
    ReactPixel.init("2780962698719127", {}, options); // DONE: Substituir "PIXEL" pelo ID do seu pixel
    ...
    fetch(
      " https://us-central1-pdf-chatter-bdadd.cloudfunctions.net/facebookCapi",
      {
        // DONE: Substituir "URL_FACEBOOKCAPI" pela URL do seu endpoint
        method: "POST",
        headers: {
